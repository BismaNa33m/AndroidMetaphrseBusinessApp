...
public class contactus extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        switch (id) {
            ...
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(contactus.this, Auftrag.class));
    ...
    public void onClickImpres(View view)
    {
        startActivity(new Intent(contactus.this, Impressum.class));
    }
    public void onClickagb(View view)
    {
        startActivity(new Intent(contactus.this, AGB.class));
    }
    public void onClickDate(View view)
    {
        startActivity(new Intent(contactus.this, Datenz.class));
    }
