...
public class Fluster extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fluster);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                startActivity(new Intent(Fluster.this, MainActivity.class));
            ...
            case R.id.help:
                startActivity(new Intent(Fluster.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(Fluster.this, Auftrag.class));
