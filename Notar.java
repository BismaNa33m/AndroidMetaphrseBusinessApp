...
public class Notar extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notar);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                startActivity(new Intent(Notar.this, MainActivity.class));
            ...
            case R.id.help:
                startActivity(new Intent(Notar.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(Notar.this, Auftrag.class));
