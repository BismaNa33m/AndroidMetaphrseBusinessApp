...
public class Telefon extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                startActivity(new Intent(Telefon.this, MainActivity.class));
            ...
            case R.id.help:
                startActivity(new Intent(Telefon.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(Telefon.this, Auftrag.class));
