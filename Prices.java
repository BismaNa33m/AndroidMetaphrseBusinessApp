...
public class Prices extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                startActivity(new Intent(Prices.this, MainActivity.class));
            ...
            case R.id.help:
                startActivity(new Intent(Prices.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(Prices.this, Auftrag.class));
