...
public class Service extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.help:
                startActivity(new Intent(Service.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(Service.this, Auftrag.class));
    ...
    public void onClickSo(View view) {
        ...
        startActivity(new Intent(Service.this, Bega.class));

    }
    public void onClickSt(View view) {

        startActivity(new Intent(Service.this, Dolme.class));

    }

    public void onClickSth(View view) {

        startActivity(new Intent(Service.this, Lecto.class));

    }

    public void onClickSf(View view) {

        startActivity(new Intent(Service.this, Notar.class));

    }

    public void onClickSfi(View view) {

        startActivity(new Intent(Service.this, Telefon.class));

    }

    public void onClickSs(View view) {

        startActivity(new Intent(Service.this, Fluster.class));
