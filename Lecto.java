...
public class Lecto extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lecto);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                startActivity(new Intent(Lecto.this, MainActivity.class));
            ...
            case R.id.help:
                startActivity(new Intent(Lecto.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if (isConnected()) {
                    ...
                    startActivity(new Intent(Lecto.this, Auftrag.class));
