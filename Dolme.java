...
public class Dolme extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                startActivity(new Intent(Dolme.this, MainActivity.class));
            ...
            case R.id.help:
                startActivity(new Intent(Dolme.this, Feedback.class));
                break;
            case R.id.upload:
                ...
                if(isConnected())
                {
                    ...
                    startActivity(new Intent(Dolme.this, Auftrag.class));
